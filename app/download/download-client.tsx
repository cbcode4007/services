  ...
  return (
    <>
      <div className="flex flex-col min-h-screen pt-28 items-center">
        ...
        <div className="h-64 md:h-128 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-transparent">
          ...
          <h3 className="mx-auto text-center text-2xl text-zinc-50 pt-4 pb-2">
              Installation
          </h3>

          <div className="flex flex-1 py-2 gap-4 w-full max-h-41 max-w-lg flex-col items-start">
